...
public:
   ...
   * @description
   * 本节的示例程序将成绩划分成high
   * pass、pass和fail三种，扩展该程序使其进一步将60分到75分之间的成绩设定为low
   ...
   * 如果grade大于90，那么将会执行：finalgrade="high
   * pass"?"fail":"pass";返回的是fail。 可以这样理解：((grade>90)?"high
   * pass"):(grade<60)?"fail":"pass") 如果grade小于90，正确返回值。
   * */
  static void
  meaninglessFunction_2(); /* TODO 23-6-5
                              没有搞明白条件运算符满足左结合律的推理过程 */
};
