...
public:
   ...
   * 0000,0000 0000,0000 0000,0000 0111,0001转换为：1111,1111 1111,1111
   * 1111,1111 1000,1110 再经过左移6位得到：1111,1111 1111,1111 1110,0011
   * 1000,0000。转换为八进制为：FFFF E380
   * */
   ...
   * 练习4.26
   * @description
   * 在本节关于测验成绩的例子中，如果使用unsigned
   * int作为quiz1的类型会发生什么情况？
   */
