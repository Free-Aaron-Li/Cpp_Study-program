...
void Exercise_13_2::meaninglessFunction_1() {}

void Exercise_13_2::meaninglessFunction_2() {}

void Exercise_13_2::meaninglessFunction_3() {}

void Exercise_13_2::meaninglessFunction_4() {}

void Exercise_13_2::meaninglessFunction_5() {}

void Exercise_13_2::exercise_13_22() {
  Has_Ptr v1;
  Has_Ptr v2("hello");
...
public:
  ...
  TreeNode(std::string value, int count)
      : _value(std::move(value)), _count(count), _left(nullptr),
        _right(nullptr) {}
...
TreeNode::TreeNode(const TreeNode &obj)
    : _value(obj._value), _count(obj._count), _left(nullptr), _right(nullptr) {
  if (obj._left)
...
void TreeNode::setValue(const std::string &value) { _value = value; }

void TreeNode::setCount(int count) { _count = count; }
...
BinStrTree::BinStrTree(const BinStrTree &obj)
    : _root(new TreeNode(*obj._root)), _use(obj._use) {
  ++*_use;
}
...
BinStrTree &BinStrTree::operator=(const BinStrTree &obj) {
  ++*obj._use;
  if (--*_use == 0) {
    delete _root;
    delete _use;
...
void Exercise_13_2::exercise_13_28() {
