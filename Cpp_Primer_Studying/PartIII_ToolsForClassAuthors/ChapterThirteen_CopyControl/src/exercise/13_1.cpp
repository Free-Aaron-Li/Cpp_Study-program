...
void Exercise_13_1::meaninglessFunction_1() {}
void Exercise_13_1::meaninglessFunction_2() {}
void Exercise_13_1::meaninglessFunction_3() {}
void Exercise_13_1::meaninglessFunction_4() {}
void Exercise_13_1::meaninglessFunction_5() {}
void Exercise_13_1::meaninglessFunction_6() {}
void Exercise_13_1::meaninglessFunction_7() {}
void Exercise_13_1::meaninglessFunction_8() {}
void Exercise_13_1::meaninglessFunction_9() {}
void Exercise_13_1::meaninglessFunction_10() {}
void Exercise_13_1::meaninglessFunction_11() {}
void Exercise_13_1::meaninglessFunction_12() {}
...
void Exercise_13_1::exercise_13_5() {
...
void Exercise_13_1::exercise_13_8() {
  HasPtr hasPtr_1 = std::string("world");
  HasPtr hasPtr_2 = hasPtr_1;
  hasPtr_1.set("hello");
  std::cout << hasPtr_1.get() << " " << hasPtr_2.get() << "\n";
}
void Exercise_13_1::exercise_13_11() {
  HasPtr hasPtr_1 = std::string("world");
  HasPtr hasPtr_2 = hasPtr_1;
  hasPtr_1.set("hello");
  std::cout << hasPtr_1.get() << " " << hasPtr_2.get() << "\n";
...
struct X {
  ...
  X &operator=(const X &obj) {
    std::cout << "operator=(const X &obj)" << std::endl;
  }
  ~X() { std::cout << "~X()" << std::endl; }
};

void function_v1(X x) {}
void function_v2(X &x) {}

void Exercise_13_1::exercise_13_13() {
...
void Exercise_13_1::exercise_13_14() {
  numbered a, b = a, c = b;
  f(a); // 1
  f(b); // 1
  f(c); // 1
...
void f(numbered_v2 s) { std::cout << s.mysn << "\n"; }

void Exercise_13_1::exercise_13_15() {
...
//------------------------------------------------------------------------------------------------
//
void f_v2(const numbered_v2 &s) { std::cout << s.mysn << "\n"; }

void Exercise_13_1::exercise_13_16() {
  numbered_v2 a, b = a, c = b; // a=1, b=2, c=3
  f_v2(a);                     // 1
  f_v2(b);                     // 2
  f_v2(c);                     // 3
...
const std::string &Employee::getName() const { return _name; }
Employee::id_type Employee::getID() const { return _id; }

void Exercise_13_1::exercise_13_18() {
  Employee v1;
...
public:
  ...
  explicit Employee_v2(std::string name)
      : _name(std::move(name)), _id(++_e_id) {}
...
const std::string &Employee_v2::getName() const { return _name; }
Employee_v2::id_type Employee_v2::getID() const { return _id; }
Employee_v2 &Employee_v2::operator=(const Employee_v2 &obj) {
  _name = obj._name;
  // _id   = obj._id; // keep the old id
  return *this;
}
void Exercise_13_1::exercise_13_19() {
  Employee_v2 v1;
